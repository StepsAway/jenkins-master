...
```
docker run -p 8080:8080 -p 50000:50000 -v /your/home:/var/jenkins_home jenkins-master
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 -v /var/jenkins_home jenkins-master
```

Then myjenkins container has the volume (please do read about docker volume handling to find out more).

Finally this image contains Docker and permits _DooD_ requets. To allow for docker commands to run within the container

```
docker run -p 8080:8080 -p 50000:50000 -v /your/home:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock jenkins-master
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com jenkins-master
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home jenkins-master
```
...
```
docker run jenkins-master --version
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001 jenkins-master
```
